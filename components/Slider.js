            ...
            <section class="flex items-center justify-center py-20 bg-white min-w-screen">
                <div class="px-16 bg-white">
                    <div class="container flex flex-col items-start mx-auto lg:items-center">
                        <p class="relative flex items-start justify-start w-full text-lg font-bold tracking-wider text-pink-500 uppercase lg:justify-center lg:items-center">Don't just take our word for it</p>
                        ...
                        <div class="items-center justify-center w-full mt-12 mb-4 lg:flex">
                            <div class="flex flex-col items-start justify-start w-full h-auto mb-12 lg:w-1/3 lg:mb-0">
                                ...
                                <blockquote class="mt-8 text-lg text-gray-500">"They actually use the ZocDoc's generated PDF document that we fill. Made my day :)"</blockquote>
                            </div>
                            <div class="flex flex-col items-start justify-start w-full h-auto px-0 mx-0 mb-12 border-l border-r border-transparent lg:w-1/3 lg:mb-0 lg:px-8 lg:mx-8 lg:border-gray-200">
                                ...
                                <blockquote class="mt-8 text-lg text-gray-500">"Dr. BalaChandra is great and the office is conveniently located right off the interstate for super fast visits.
                                    easier.
                            ...
                            <div class="flex flex-col items-start justify-start w-full h-auto lg:w-1/3">
                                ...
                                <blockquote class="mt-8 text-lg text-gray-500">"First appointment is a phone call, but seems good so far. Given lab request via email and will follow up.
                                    looking
