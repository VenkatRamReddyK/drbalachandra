        ...
        <section className="bg-white">
            <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                ...
                <p className="mt-8 text-base leading-6 text-center text-gray-400">
                    © 2021 Dr Bala, Inc. All rights reserved.
                </p>
                <p className="text-sm leading-6 text-center text-gray-400">
                    <a href="https://www.flaticon.com/free-icons/tooth" title="tooth icons">Icons created by Freepik - Flaticon</a>
                </p>
            </div>
        </section>
